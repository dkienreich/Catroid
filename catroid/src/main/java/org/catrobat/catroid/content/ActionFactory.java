...
public class ActionFactory extends Actions {
	...
	public Action createJumpingSumoTurnAction(long seconds) {
	...
	public Action createJumpingSumoAnimationAction(Sprite sprite, JumpingSumoAnimationsBrick.Animation animationEnum, long seconds) {
	...
	public Action createJumpingSumoRotateLeftAction(Sprite sprite, Formula degree, long seconds) {
	...
	public Action createJumpingSumoRotateRightAction(Sprite sprite, Formula degree, long seconds) {
